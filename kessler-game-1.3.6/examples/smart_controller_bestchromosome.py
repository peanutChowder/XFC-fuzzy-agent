...
class SmartController(KesslerController):    
    def __init__(self):
        ...
        self.chromosome = {
            'bullet_time': [0, 0, 0.05, 0, 0.13953120977457778, 0.15, 0.0, 0.2], 
            'theta_delta': [-3.141592653589793, -1.7453292519943295, -2.356194490192345, -1.8686027441513713, -0.7853981633974483, -1.5707963267948966, -0.8201080747901244, 0, -0.017453292519943295, 0.009584383698668802, 0.017453292519943295, 0, 1.1632429314449222, 1.5707963267948966, 0.7853981633974483, 1.4485319099297818, 2.356194490192345, 1.7453292519943295, 3.141592653589793], 
            'asteroidDistance': [0, 0, 200, 100, 101.48970099849343, 200, 200, 350], 
            'asteroidSpeed': [0, 48.98745166212213, 30, 76.07035417757248], 
            'currVelocity': [-300, -250, -100, -150, -51.95664501955507, 5, -5, 3.4155333146085702, 5, 100, 134.93968610166894, 300, 5, 90, 200], 
            'ship_turn': [-180, -100, -135, -115.32681775884114, -45, -90, -23.498219866675626, 0, -1, 0.15754502952669047, 1, 0, 70.76968505711935, 90, 45, 63.62856788599581, 135, 100, 180], 
            'ship_fire': [-1, -1, 0.0, 0.0, 1, 1], 'thrust': [-300, -300, -150, -200, -133.64670211907716, 50, -5, 0.22446943706403566, 5, 150, 300, 300, 50, 95.9783670537486, 200]
        }
